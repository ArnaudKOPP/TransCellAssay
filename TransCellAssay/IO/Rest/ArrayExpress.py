...
class ArrayExpressConnection(REST):
    """
    ...
    def __init__(self, verbose=False):
        super(ArrayExpressConnection, self).__init__(name="ArrayExpress", url=self.DEFAULT_ADDRESS, verbose=verbose)
    ...
    def _cache_urlopen(self, url, timeout=30):
        if self.cache is not None:
            ...
            stream = urllib.urlopen(url, timeout=timeout)
            data = stream.read()
            ...
            return urllib.urlopen(url, timeout=timeout)
